...
if ( !class_exists( 'STUL_Class' ) ) {
    ...
    class STUL_Class {
        ...
        function define_constants() {
            ...
            global $wpdb;
            defined( 'STUL_VERSION' ) or define( 'STUL_VERSION', '1.1.0' ); // Plugin's active version
            ...
            defined( 'STUL_CC_API_URL' ) or define( 'STUL_CC_API_URL', 'https://api.constantcontact.com/v2/' ); //Constant Contact default api url
